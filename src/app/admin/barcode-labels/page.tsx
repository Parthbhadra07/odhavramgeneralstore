              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField label="Font Size (px)">
                  <Input
                    ...
                    onChange={(e) =>
                      saveBarcodePrinterPrefs({ fontSize: Number(e.target.value) })
                    }
                  />
                </FormField>
              </div>
          ...
          <div className="admin-card p-4 sm:p-5">
            ...
            <div className="space-y-3">
              <SelectField
                ...
                onChange={(v) =>
                  saveBarcodePrinterPrefs({
                    paperType: v as BarcodeLabelConfig["paperType"],
                  })
                }
                options={BARCODE_PAPER_OPTIONS.map((o) => ({
                  value: o.value,
                  label: o.label,
                }))}
                placeholder=""
              ...
              <SelectField
                ...
                onChange={(v) =>
                  saveBarcodePrinterPrefs({
                    printDensity: v as BarcodeLabelConfig["printDensity"],
                  })
                }
                options={PRINT_DENSITY_OPTIONS.map((o) => ({
                  value: o.value,
                  label: o.label,
                }))}
                placeholder=""
              ...
              <SelectField
                ...
                onChange={(v) =>
                  saveBarcodePrinterPrefs({
                    fontFamily: v as BarcodeLabelConfig["fontFamily"],
                  })
                }
                options={BARCODE_FONT_OPTIONS.map((o) => ({
                  value: o.value,
                  label: o.label,
                }))}
                placeholder=""
            ...
            <p className="mt-2 text-xs text-gray-500">
              ...
              {config.paperType === "label"
                ? `${config.labelWidthMm}×${config.labelHeightMm} mm labels`
